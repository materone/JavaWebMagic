...
//    private static final TreeMap<String,Object> bulks = new TreeMap<>();
    ...
    private static final String OUTFILE="g://novel-1.txt";
...
//        System.out.println("=============");
//        stores.forEach((o, o2) -> {
//            System.out.printf("Key--Store\n%s\nValues--Store\n%s\n", o, o2);
//        });
//        System.out.println("=============");
//        pages.forEach((o, o2) -> {
//            System.out.printf("Key--Pages\n%s\nValues--Pages\n%s\n", o, o2);
//        });
...
//                        stores.put(page.getUrl(), page.getRawText());
//                        pages.put(page.getUrl().toString(), page.getRawText());
                    }
                }
...
//                    System.out.println(replaceString(page.getRawText()));
        ...
        }).addUrl("https://www.baishishanhotel.com/du/43776/").addPipeline(new ConsolePipeline()).addPipeline(fp).thread(15).run();
        // 8348 无敌奶爸的捉妖日常 ; 43776 无上崛起
    }
